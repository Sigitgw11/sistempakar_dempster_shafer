        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="add_pasien.php">Proses Diagnosa</a></li>
...
?><br>
                        ...
                        <p style="font-weight:bold; text-align:center; background:#06F;"><strong>Menentukan Nilai
                                Densitas (m) Awal</strong></p>
                        <?php
...
echo "</table>";
	...
	?>
                        <p style="font-weight:bold; text-align:center; background:#06F;"><strong>Hasil
                                Perangkingan</strong></p>
                        <?php	
$arrPenyakit=array(); 
